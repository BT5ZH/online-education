                ...
                <div class="lg__b">
                    <form action="#" class="form">
                        ...
                        <div class="form__code" v-if="regisflag=='reg'">
                            <input type="text" class="form__code__txt" placeholder="验证码"
                                    id="passcode" name="passcode" required>
                            <button class="form__code__btn" >验证码</button>
                        </div>
    ...
    export default {
        ...
        watch: {
            username:function(value) {
                ...
                // }
                const emailRule=/[^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$]/g;
